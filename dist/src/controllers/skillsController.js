...
exports.recommendSkill = exports.deleteSkill = exports.updateSkill = exports.getSkillById = exports.discoverSkillsController = exports.getSkills = exports.createSkill = void 0;
...
exports.discoverSkillsController = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    const query = skillValidation_1.discoverSkillsQuerySchema.parse(req.query);
    const skills = await (0, skillService_1.discoverSkills)(query);
    res.json(skills);
});
