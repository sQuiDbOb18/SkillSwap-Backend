...
exports.getSkillRecommendation = exports.removeUserSkill = exports.updateUserSkill = exports.getUserSkillById = exports.getUserSkills = exports.addSkill = void 0;
...
const detectCategory = (skillNames) => {
    ...
    for (const skillName of skillNames) {
        ...
        for (const [category, keywords] of Object.entries(skillCategoryMatchers)) {
            ...
            if (matched) {
                matches.set(category, ((_a = matches.get(category)) !== null && _a !== void 0 ? _a : 0) + 1);
            }
        }
    }
    const sortedMatches = [...matches.entries()].sort((a, b) => b[1] - a[1]);
    return (_b = sortedMatches[0]) === null || _b === void 0 ? void 0 : _b[0];
};
...
const getSkillRecommendation = async (userId) => {
    ...
    const skillKeywords = userSkills.flatMap((skill) => [skill.title, ...skill.tags, skill.category]);
    ...
    return {
        ...
        detectedCategory: detectedCategory !== null && detectedCategory !== void 0 ? detectedCategory : null,
